...
```{r read input data 2}
otu <- read.table("/Users/kshitijtandon/Desktop/kshitij/Sinica work/Penghunesis Manuscript/Endozoicomonas-species-dynamics/data/zotu_abundance_table.txt",
                  row.names = 1, 
                  header = T, 
                  sep = "\t")
head(otu[1:5,1:5])
...
tax <- read.table("/Users/kshitijtandon/Desktop/kshitij/Sinica work/Penghunesis Manuscript/Endozoicomonas-species-dynamics/data/zotu_taxtable.txt",
                  row.names = 1,
                  header = T,
                  sep = "\t")
head(tax[1:5,1:5])
...
meta <- read.table("/Users/kshitijtandon/Desktop/kshitij/Sinica work/Penghunesis Manuscript/Endozoicomonas-species-dynamics/data/zotu_meta.txt",
                   header = T,
                   row.names = 1,
                   sep = "\t")
...
data <- read.table("/Users/kshitijtandon/Desktop/kshitij/Sinica work/Penghunesis Manuscript/Endozoicomonas-species-dynamics/data/All_phylum_only.txt",
                   header = T,
                   row.names = 1, 
                   sep = "\t")
data_t <- t(data)
...
data <- read.table("/Users/kshitijtandon/Desktop/kshitij/Sinica work/Penghunesis Manuscript/Endozoicomonas-species-dynamics/data/Endozoicomonas_only.txt",
                   header = T,
                   row.names = 1,
                   sep = "\t")
data_t <- t(data)
...
heatmap_outerbay <- read.table("/Users/kshitijtandon/Desktop/kshitij/Sinica work/Penghunesis Manuscript/Endozoicomonas-species-dynamics/data/heatmap_input_formatted_arrangeed_for_OUTER BAY plot.txt",
                               header = T, 
                               row.names = 1,
                               sep = "\t")
...
heatmap_innerbay <- read.table("/Users/kshitijtandon/Desktop/kshitij/Sinica work/Penghunesis Manuscript/Endozoicomonas-species-dynamics/data/heatmap_input_formatted_arrangeed_for_Inner BAY plot.txt",
                               header = T, 
                               row.names = 1,
                               sep = "\t")
...
write.csv(rich_stats, file = "/Users/kshitijtandon/Desktop/kshitij/Sinica work/Penghunesis Manuscript/Endozoicomonas-species-dynamics/data/observed_richness_coral_sw.csv")
write.csv(even_stats, file = "/Users/kshitijtandon/Desktop/kshitij/Sinica work/Penghunesis Manuscript/Endozoicomonas-species-dynamics/data/even_InvSimpson_coral_sw.csv")
write.csv(shan_stats, file = "/Users/kshitijtandon/Desktop/kshitij/Sinica work/Penghunesis Manuscript/Endozoicomonas-species-dynamics/data/shannon_coral_sw.csv")
write.csv(chao_stats, file = "/Users/kshitijtandon/Desktop/kshitij/Sinica work/Penghunesis Manuscript/Endozoicomonas-species-dynamics/data/chao1_coral_sw.csv")
```
...
data<-read.table(file = "/Users/kshitijtandon/Desktop/kshitij/Sinica work/Penghunesis Manuscript/Endozoicomonas-species-dynamics/data/all alpha.txt",
                 header=T,sep="\t")
...
data <- read.table("/Users/kshitijtandon/Desktop/kshitij/Sinica work/Penghunesis Manuscript/Endozoicomonas-species-dynamics/data/All_class_only.txt",
                   header = T,
                   row.names = 1, 
                   sep = "\t")
data_t <- t(data)
...
```{r ANI heatmap}
data = read.table("/Users/kshitijtandon/Desktop/kshitij/Sinica work/Penghunesis Manuscript/Endozoicomonas-species-dynamics/data/ANI_results.txt",row.names = 1)
